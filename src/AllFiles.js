    ...
    <View style={styles.container}>
      ...
      <View style={styles.slide}>
        <Swiper
          ...
          <View style={styles.slide}>
            {/* <Image
            source={require('./src/assets/images/saarc_5.png')}
            style={styles.image}
          /> */}
            <Text style={styles.title}>Welcome to Charityapp</Text>
            <Text style={styles.description}>
              Dzięki Pomagam.pl w łatwy i bezpieczny sposób zbierzesz pieniądze
              na dowolny cel
            </Text>
...
const styles = StyleSheet.create({
  ...
  image: {
    width: width - 40,
    height: (width - 40) * (812 / 375), // Adjust this ratio according to your image dimensions
    resizeMode: 'contain',
    marginBottom: 20,
  },
  title: {
...
//ERP Design Codes Here App.js Below 
...
// WelcomeScreen page Curve design codes below 
...
const images = [
  // require('./src/assets/images/saarc_6.png'),
  // require('./src/assets/images/saarc_3.png'),
  // require('./src/assets/images/saarc_4.png'),
  // require('./src/assets/images/saarc_5.png'),
  require('./src/assets/images/saarc_7.png'),
  require('./src/assets/images/saarc_8.png'),
  require('./src/assets/images/saarc_9.png'),
  require('./src/assets/images/saarc_10.png'),
];

  return (
    <View style={styles.container}>
      <StatusBar barStyle="light-content" backgroundColor="#00C6AE" />
      <View style={styles.slide}>
        <Swiper
          autoplay={true}
          autoplayTimeout={5}
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>Welcome to Saarc Masts Tech</Text>
        <Text style={styles.description}>Sign In to your ERP Account</Text>
...
// WelcomeScreen.js Curve type design in below 
...
const WelcomeScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <StatusBar barStyle="light-content" backgroundColor="#6082B6" />
